...
Usage:
    python -m src.ingestion.cli --data-dir ./data ingest my-doc.pdf
    python -m src.ingestion.cli --data-dir ./data status my-doc
    python -m src.ingestion.cli --data-dir ./data list
    python -m src.ingestion.cli --data-dir ./data index my-doc
    python -m src.ingestion.cli --data-dir ./data regions my-doc [--page 2]
    python -m src.ingestion.cli --data-dir ./data page-text my-doc 2
"""
