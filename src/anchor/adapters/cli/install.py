...
Targets:
    ...
    codex         Add a named MCP server entry to ~/.codex/config.toml.
    opencode      Add a named local MCP entry to the OpenCode JSON config.
...
from anchor.adapters.cli.install_config_io import load_json as _load_json
from anchor.adapters.cli.install_config_io import write_json as _write_json
from anchor.adapters.cli.install_named import install_codex, install_opencode
...
install_app.command("codex")(install_codex)
install_app.command("opencode")(install_opencode)
...
def install_print(
    ...
    typer.echo("")
    typer.echo("=== opencode ===")
    install_opencode(env=env, name=None, create=False, force=False, yes=True, dry_run=True)
    typer.echo("")
    typer.echo("=== cursor ===")
